...
const self = module.exports = {
     ...
     * @param {Object[]} [images] - array of properties to parse 
     * @param {Object[]} [documents] - array of properties to parse
     * @return {Object}
     */
    parseAttachements: (item, images, documents) => {
        ...
        return _.mapValues(item, (v, k) => {
            ...
            if(images.indexOf(k) != -1 && !_.isArray(v) && v) {
                return parsePreview(v, 500);
            }

            if(images.indexOf(k) != -1 && _.isArray(v)) {
                return  _.map(v, c => { 
                            if(c.image) {  
